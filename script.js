...
const WMO_DESC = { 0:'Klarer Himmel', 1:'Überwiegend klar', 2:'Teilweise bewölkt', 3:'Bedeckt', 45:'Nebel', 51:'Nieselregen', 61:'Regen', 71:'Schnee', 80:'Schauer', 95:'Gewitter' };
...
function renderLinks() {
    ...
    links.forEach((link, i) => {
        ...
        chip.innerHTML = `${link.name} <button class="link-chip-del" onclick="deleteLink(event,${i})"><i class="fas fa-xmark"></i></button>`;
